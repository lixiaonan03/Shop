...
public class OrderEvaluateActivity extends BaseActivity {
	...
	private void initwebview() {
		...
		webview.addJavascriptInterface(new JavaScriptInterface(), "order");
	...
	class JavaScriptInterface {
		...
		public void submit() {
			...
			intent.setClass(OrderEvaluateActivity.this, MyorderActivity.class);
			intent.putExtra("goflag", 4);
		...
		public void gooddetail(String id) {
			// 跳转商品详情的
			Intent intent = new Intent();
			intent.setClass(OrderEvaluateActivity.this,
					ProductdeatilActivity.class);
			intent.putExtra("flag", 2);
			intent.putExtra("id", StrToNumber.strTolong(id));
			startActivity(intent);
		}
