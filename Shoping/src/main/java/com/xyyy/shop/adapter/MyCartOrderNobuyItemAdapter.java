...
/**
 * 购物车订单展示商品类表使用的适配器  (不能购买的)
 * @author lxn
 */
public class MyCartOrderNobuyItemAdapter extends BaseAdapter {
	private Context _context;
	private List<Cart> _list;

	public MyCartOrderNobuyItemAdapter(Context context, List<Cart> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Holder holder;
		if (null == convertView) {
			convertView = View.inflate(_context, R.layout.adapter_mycartordernobuy_item,
					null);
			holder = new Holder();
