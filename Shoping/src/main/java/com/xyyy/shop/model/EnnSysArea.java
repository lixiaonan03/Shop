...
public class EnnSysArea implements Serializable{
	...
	public String getAreaSimpName() {
		return this.areaSimpName;
	}

	public void setAreaSimpName(String areaSimpName) {
		this.areaSimpName = areaSimpName;
	}
