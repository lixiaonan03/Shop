...
public class EnnGoods {
    ...
    /**
      * 商品总评价分
      **/
	private java.math.BigDecimal goodsEvals;
    /**
      * 商品总销量分
      **/
	private java.math.BigDecimal goodsSales;
    /**
      * 
      **/
    ...
    /**
      * 包装[长]- 单位：CM
      **/
	private java.math.BigDecimal goodsLength;
    /**
      * 包装[宽]- 单位：CM
      **/
	private java.math.BigDecimal goodsWidth;
    /**
      * 包装[高]- 单位：CM
      **/
	private java.math.BigDecimal goodsHigh;
    /**
      * 会员卡类型ID:具体关联某一种会员卡：
	...
	public java.math.BigDecimal getGoodsEvals() {
	...
	public void setGoodsEvals(java.math.BigDecimal goodsEvals) {
		this.goodsEvals = goodsEvals;
	}
	public java.math.BigDecimal getGoodsSales() {
	...
	public void setGoodsSales(java.math.BigDecimal goodsSales) {
	...
	public java.math.BigDecimal getGoodsLength() {
		return this.goodsLength;
	}

	public void setGoodsLength(java.math.BigDecimal goodsLength) {
		this.goodsLength = goodsLength;
	}
	public java.math.BigDecimal getGoodsWidth() {
		return this.goodsWidth;
	}

	public void setGoodsWidth(java.math.BigDecimal goodsWidth) {
		this.goodsWidth = goodsWidth;
	}
	public java.math.BigDecimal getGoodsHigh() {
		return this.goodsHigh;
	}

	public void setGoodsHigh(java.math.BigDecimal goodsHigh) {
